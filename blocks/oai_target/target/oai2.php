...
* |                                                                      |
* +----------------------------------------------------------------------+
* | Derived from work by U. Mόller, HUB Berlin                           |
* |                                                                      |
...
require_once('lib/oaidp-config.php');
...
if (isset($args['verb'])) {
	switch ($args['verb']) {
		...
		case 'Identify':
			...
			$compress = FALSE;
			include 'lib/identify.php';
			break;

		case 'ListIdentifiers':
			unset($args['verb']);
			include 'lib/listidentifiers.php';
			break;

		case 'ListMetadataFormats':
			unset($args['verb']);
			include 'lib/listmetadataformats.php';
			break;

		case 'ListRecords':
			unset($args['verb']);
			include 'lib/listrecords.php';
			break;

		case 'ListSets':
			unset($args['verb']);
			include 'lib/listsets.php';
			break;
